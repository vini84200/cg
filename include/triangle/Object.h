...
enum VAO_IDs { ModelSpace, CameraSpace, NumVAOs };
...
enum Attrib_IDs { vPosition = 0, vNormals = 1, vTextureCoord = 2 };

enum IndicesType { TriangleType, TriangleStripType, TriangleFanType };
